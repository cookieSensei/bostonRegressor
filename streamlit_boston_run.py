...
boston_regressor = joblib.load("BostonForestRegressor")
...
prediction = boston_regressor.predict(df)

st.header('Prediction of MEDV')
st.write(prediction)
st.write('---')

# Explaining the boston_regressor's predictions using SHAP values
# https://github.com/slundberg/shap
explainer = shap.TreeExplainer(boston_regressor)
